...
- [ ] **M14** ⭐ Page-edit layer + form filling (fill existing AcroForm fields) — *WSL (model+tests) + WSLg* — split into two PRs: **PR-A** model foundation + materialise + headless tests (PR pending); **PR-B** inline viewer fill (next)
